...
/* Build identity, generated by make so that a commit or dirty-state change rebuilds
 * the translation units that stamp it into binaries and checkpoints. The fallbacks
 * keep a build possible outside make; a binary reporting 0.0.0 is saying exactly that. */
#if defined(__has_include)
#  if __has_include("picurv_build_identity.h")
#    include "picurv_build_identity.h"
#  endif
#endif
