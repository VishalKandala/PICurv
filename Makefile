...
SIMULATOR_OBJS := $(addprefix $(OBJDIR)/, \
                 simulator.o setup.o checksum.o statistics_moments.o statistics_target.o field_catalog.o particle_field_catalog.o logging.o grid.o io.o Metric.o AnalyticalSolutions.o\
...
POSTPROCESSOR_OBJS := $(addprefix $(OBJDIR)/, \
                     postprocessor.o setup.o checksum.o statistics_moments.o statistics_target.o field_catalog.o particle_field_catalog.o logging.o grid.o io.o Metric.o AnalyticalSolutions.o\
...
unit: unit-geometry unit-setup unit-solver unit-newton-krylov unit-particles unit-statistics unit-statistics-target unit-io unit-logging unit-post unit-grid unit-metric unit-boundaries unit-poisson-rhs unit-runtime unit-periodic
