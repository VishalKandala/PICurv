...
- `picurv cancel --run-dir ... --stage solve --graceful` sends the solver shutdown signal so the runtime can write the latest safe off-cadence checkpoint before exiting.
